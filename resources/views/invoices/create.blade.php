    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3">
            ...
            <div class="input-group">
                <input type="number" name="discount" id="discountNominal" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount', 0) }}" min="0" step="1000" oninput="calcGrand()" placeholder="Nominal" aria-describedby="discountHelp">
                <input type="number" name="discount_percent" id="discountPercent" class="form-control @error('discount_percent') is-invalid @enderror d-none" value="{{ old('discount_percent') }}" min="0" max="100" step="0.5" oninput="calcGrandPercent()" placeholder="Contoh: 10" aria-describedby="discountHelp" disabled>
...
function toggleDiscountType() {
    ...
    const nominal = document.getElementById('discountNominal');
    const percent = document.getElementById('discountPercent');
    nominal.classList.toggle('d-none', type === 'percent');
    percent.classList.toggle('d-none', type === 'fixed');
    nominal.disabled = type === 'percent';
    percent.disabled = type === 'fixed';
    document.getElementById('discountHelp').innerHTML = type === 'percent'
        ? 'Mode <strong>%</strong> aktif: masukkan angka saja, contoh <strong>10</strong> untuk diskon 10%.'
        : 'Mode <strong>Rp</strong> aktif: masukkan nominal rupiah, contoh <strong>50000</strong>.';

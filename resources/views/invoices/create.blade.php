    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3">
            ...
            <div class="input-group">
                ...
                <input type="number" name="discount_percent" id="discountPercent" class="form-control @error('discount_percent') is-invalid @enderror d-none" value="{{ old('discount_percent') }}" min="0" max="100" step="0.5" oninput="calcGrandPercent()" placeholder="Persen">

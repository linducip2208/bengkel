...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="fas fa-globe me-2"></i>Edit Negara</h4>
    ...
    <form action="{{ route('countries.update', $country) }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-3">
                ...
                <input type="text" name="code" class="form-control text-uppercase @error('code') is-invalid @enderror" value="{{ old('code', $country->code) }}" maxlength="2">

...
@section('content')
<h4 class="mb-3">Catat Pemasukan Baru</h4>
...
<form method="POST" action="{{ route('incomes.store') }}">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            ...
            <input type="text" name="label" class="form-control @error('label') is-invalid @enderror" value="{{ old('label') }}" required placeholder="contoh: Penjualan Oli, Servis AC">
        ...
        <div class="col-md-4">
            ...
            <select name="bank_account_id" class="form-select @error('bank_account_id') is-invalid @enderror">
                ...
                @foreach ($bankAccounts as $ba)
                    <option value="{{ $ba->id }}" {{ old('bank_account_id') == $ba->id ? 'selected' : '' }}>{{ $ba->bank_name }} — {{ $ba->account_number }}</option>
                @endforeach
            </select>
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="invoice_number" class="form-control @error('invoice_number') is-invalid @enderror" value="{{ old('invoice_number') }}" placeholder="opsional">

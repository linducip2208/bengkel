...
<body>
    ...
    <main>
        ...
        <section class="content">
            <h2>Why Choose Bengkel Paten for {{ $repairCategory->repair_category_name }}?</h2>
            <p>At Bengkel Paten, we pride ourselves on delivering exceptional automotive care. Our {{ strtolower($repairCategory->repair_category_name) }} services stand out because of our commitment to quality, transparency, and customer satisfaction.</p>
        ...
        <section class="cta content">
            ...
            <p>Don't wait until a minor issue becomes a major repair. Schedule your {{ strtolower($repairCategory->repair_category_name) }} service with Bengkel Paten and experience professional automotive care.</p>

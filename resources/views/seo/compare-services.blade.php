...
<body>
    ...
    <main>
        ...
        <section class="content">
            ...
            <p>{{ $categoryA->repair_category_name }} is the right choice when your vehicle shows specific symptoms related to this category. Our certified technicians at Bengkel Paten can properly diagnose whether this service is what your vehicle needs.</p>
            <p>With over {{ $servicesA }} completed services in this category, Bengkel Paten has the expertise to deliver quality {{ strtolower($categoryA->repair_category_name) }} results at an average price of @money($avgPriceA).</p>
        </section>
        ...
        <section class="content">
            ...
            <p>At Bengkel Paten, we begin every visit with a comprehensive inspection. Our technicians check the relevant systems and provide you with a clear explanation of what needs attention, why it matters, and how we can help.</p>
        ...
        <section class="faq content">
            ...
            <div class="faq-item">
                ...
                <p>{{ $avgPriceA > $avgPriceB ? $categoryA->repair_category_name : $categoryB->repair_category_name }} tends to have a higher average price based on our service history, but every vehicle is different. Get a personalized quote at Bengkel Paten.</p>
            </div>
            <div class="faq-item">
        ...
        <section class="cta content">
            <h2>Get Expert Advice at Bengkel Paten</h2>
            <p>Not sure which service your vehicle needs? Visit Bengkel Paten for a professional diagnostic check and personalized recommendations.</p>
        </section>
    </main>

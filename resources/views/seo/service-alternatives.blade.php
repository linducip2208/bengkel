...
<body>
    ...
    <main>
        <section class="content">
            ...
            <p>Below are alternative service categories available at Bengkel Paten that might be relevant to your vehicle's condition:</p>
        ...
        <section class="content">
            ...
            <p>At Bengkel Paten, we always start with a thorough inspection before recommending any service. This ensures you only pay for what your vehicle actually needs.</p>
        </section>

        <section class="cta content">
            <h2>Not Sure What You Need?</h2>
            <p>Bring your vehicle to Bengkel Paten for a professional inspection. Our certified technicians will diagnose the issue and recommend the right service category for your needs.</p>

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="fas fa-chart-pie me-2"></i>Tambah Budget</h4>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="category" class="form-select @error('category') is-invalid @enderror" required>
                    <option value="revenue" {{ old('category') === 'revenue' ? 'selected' : '' }}>Revenue (Pendapatan)</option>
                    <option value="expense" {{ old('category') === 'expense' ? 'selected' : '' }}>Expense (Pengeluaran)</option>
                </select>

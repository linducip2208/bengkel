...
<head>
    <meta charset="UTF-8">
    <title>Login Customer Portal — {{ config('app.name', 'Aplikasi Bengkel Terbaik') }}</title>
    ...
    <div class="container">
        <div class="card mx-auto" style="max-width: 420px; border-radius: 18px;">
            <div class="card-body p-4">
                ...
                <p class="text-muted text-center small">{{ config('app.name', 'Aplikasi Bengkel Terbaik') }}</p>

...
(function () {
    ...
    function rowHtml(key, type) {
        ...
        return '<tr data-type="' + type + '">'
            ...
            + '<td data-label="Item / Deskripsi"><div class="d-flex gap-1"><input type="text" name="items[' + key + '][description]" class="form-control form-control-sm est-desc" placeholder="Deskripsi item" maxlength="500" required><input type="hidden" name="items[' + key + '][product_id]" class="est-product-id" value=""><input type="hidden" name="items[' + key + '][service_catalog_id]" class="est-service-catalog-id" value=""><button type="button" class="btn btn-sm btn-outline-primary catalog-trigger" title="Cari katalog" aria-label="Cari katalog"><i class="fas fa-search"></i></button></div><small class="item-meta text-muted"></small></td>'
            + '<td data-label="Qty"><input type="number" step="0.001" min="0.001" name="items[' + key + '][quantity]" class="form-control form-control-sm est-qty text-center" value="1" required></td>'
            + '<td data-label="Harga"><input type="number" step="0.01" min="0" name="items[' + key + '][unit_price]" class="form-control form-control-sm est-price text-end" value="0" required></td>'

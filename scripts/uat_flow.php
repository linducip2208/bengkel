...
$ok = []; $err = [];
function _ok(&$ok, $msg) { $ok[] = $msg; echo "✓ $msg\n"; }
function _err(&$err, $msg) { $err[] = $msg; echo "✗ $msg\n"; }
...
try {
    ...
    $tech = \App\Models\ServiceTechnician::create([
        'service_id' => $svc->id,
        'user_id' => $user->id,
        'commission_pct' => 10,
    ...
    $obType = \App\Models\ObservationType::first();
    $obPoint = $obType ? \App\Models\ObservationPoint::where('observation_type_id', $obType->id)->first() : null;
    if ($obPoint) {
        $sop = \App\Models\ServiceObservationPoint::create([
            'service_id' => $svc->id,
    ...
    $sr = \App\Models\StockRecord::create([
        'product_id' => $p->id,
        'quantity' => 50,
        'minimum_stock' => 5,
        'branch_id' => $branch->id,
    ...
    // -- 14. Stock history
    $sh = \App\Models\StockHistory::create([
        'product_id' => $p->id,
        'quantity_change' => 10,
        'previous_stock' => 50,
        'new_stock' => 60,
    ...
    $tpl = \App\Models\NotificationTemplate::create([
    ...
    $rem = \App\Models\Reminder::create([
        'customer_id' => $c->id,
        'vehicle_id' => $v->id,
        'service_id' => $svc->id,
    ...
    $note = \App\Models\Note::create([
        'notable_type' => \App\Models\Customer::class,
        'notable_id' => $c->id,
        'content' => 'UAT note',
        'created_by' => $user->id,
    ]);
    ...
    if (Schema::hasTable('pos_sessions')) {
        ...
        $posInv = \App\Models\Invoice::create([

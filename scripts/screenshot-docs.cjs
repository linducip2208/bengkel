...
const PAGES = [
    ...
    { path: '/insurance-claims', name: 'insurance-list', label: 'Insurance Claims' },
    { path: '/supplier-claims', name: 'supplier-claims-list', label: 'Supplier Claims' },
    { path: '/fleet-contracts', name: 'fleet-contract-list', label: 'Fleet Contracts' },
    { path: '/companies', name: 'company-list', label: 'Companies' },
    { path: '/technician-skills', name: 'technician-skills', label: 'Skill Matrix' },
    { path: '/bank-accounts', name: 'bank-account-list', label: 'Bank Accounts' },
    { path: '/bank-reconciliations', name: 'bank-reconciliation-list', label: 'Bank Reconciliation' },
    { path: '/budgets', name: 'budget-list', label: 'Budgets' },
    { path: '/purchase-requisitions', name: 'purchase-requisition-list', label: 'Purchase Requisitions' },
    { path: '/sell-returns', name: 'sell-return-list', label: 'Sell Returns' },

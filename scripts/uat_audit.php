...
foreach (Route::getRoutes() as $route) {
    ...
    if (!isset($action['controller']) || !str_contains($action['controller'], '@')) continue;
...
foreach (glob($modelsDir . '/*.php') as $file) {
    ...
    try {
        ...
        foreach ($ref->getMethods(ReflectionMethod::IS_PUBLIC) as $method) {
            ...
            if ($typeName !== 'Illuminate\Database\Eloquent\Relations\BelongsTo') continue;
            try {
